...
- It's a repo with jupyter notebooks used in the paper "Sine-Enveloped Cosine Annealing" . The codes are runned on Linux system , if you are a Linux user , you can simply run "bash control.sh" . Windows/MacOS users need to convert this .sh file into their specific versions .
